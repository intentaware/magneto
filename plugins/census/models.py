...
class SubjectConcept(models.Model):
    ...
    census_description = models.TextField(blank=True, null=True)
    census_history = models.TextField(blank=True, null=True)
    census_comparability = models.TextField(blank=True, null=True)
    census_notes = models.TextField(blank=True, null=True)
    description = models.TextField(blank=True, null=True)
    source = models.CharField(max_length=64, blank=True, null=True, default="American Community Survey Subject Definitions")
